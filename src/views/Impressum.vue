...
<div class="Impressum">
    ...
    <h3>Hoster</h3>
    <p>Diese Webseite läuft auf <a href="https://www.strato.de/" target="_blank" rel="noopener noreferrer">Strato</a> Servern </p>

    <h3>Google Fonts</h3>
    <p>Alle Fonst/Schriftarten sind lokal auf dem Server gespeichert und werden nicht von Google Servern runtergeladen.</p>
